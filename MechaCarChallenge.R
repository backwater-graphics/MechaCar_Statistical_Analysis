...
# Import the data
mecha_car_mpg <- read.csv(file='/Users/uhlir/MechaCar_Statistical_Analysis/Resources/MechaCar_mpg.csv',check.names = F, stringsAsFactors = F)
...
### DELIVERABLE 2 ###
# Import the data
sus_coil <- read.csv(file='/Users/uhlir/MechaCar_Statistical_Analysis/Resources/Suspension_Coil.csv', check.names = F, stringsAsFactors = F)
